    ...
    return (
        <div className = "w-full flex flex-col items-center justify-center font-press-start">
            <div className = "w-80 relative">
                ...
                <Link to="/qr-code" state={state} className = "fixed bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap cursor-pointer py-2.5 px-28 bg-[#05C46B] text-white rounded-md text-base ">
                    SCAN QR-CODE
                </Link>
            </div>
        </div>
